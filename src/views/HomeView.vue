<template>
  <AppNavbar class="relative" />

  <section
    class="max-w-[95vw] sm:max-w-[754px] xl:max-w-[1240px] w-full mx-auto flex flex-col justify-center items-center"
  >
    <div
    ...
    >
      ...
      <h1 id="title" class="leo"></h1>
      <div
        class="flex flex-col gap-6 lg:flex-row sm:gap-6 sm:justify-center px-4"
      >
        <div
...
const services = ref([
  {
    id: 1,
    description:
      "I create web applications or websites that are functional, responsive, and user-friendly. Understanding client requirements, developing the necessary features and functionality, and ensuring the site is optimized for performance.",
  ...
  },
  {
    id: 2,
    description:
      "Websites require regular updates and maintenance to stay current and secure. I offer ongoing support to keep your site in top shape, address any issues that arise, and make necessary updates to ensure it continues to meet your evolving needs.",
  ...
  },
  {
    id: 3,
    description:
      "I create visually appealing and intuitive user interfaces. Designing wireframes, prototypes, and mockups, selecting appropriate color schemes and typography, and ensuring consistency and usability across different devices.",
    title: "UI / UX Design",
